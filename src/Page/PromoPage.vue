<template>
  <div class="container">
    <header>
      ...
      <div class="filters">
          <div class="filter active"><i class="fas fa-filter"></i><span>Filters</span></div>
          <div class="filter"><i class="fas fa-location-arrow"></i> <span>Nearby</span></div>
          <div class="filter"><i class="far fa-star"></i><span>Above 4.5</span></div>
